<%-- 
    Document   : ceoAccntngCharts
    Created on : Oct 11, 2016, 1:01:48 AM
    Author     : r.chua
--%>
            ...
            <div class="menu-list">
                <ul id="menu-content" class="menu-content collapse out">
                    ...
                    <ul class="sub-menu collapsed" id="products">
                        <li class="active"><a href="ceoAccntngCharts.jsp">Accounting</a></li>
                        <li><a href="ceoInventoryCharts.jsp">Inventory</a></li>
