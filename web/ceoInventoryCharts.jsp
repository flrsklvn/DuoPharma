<%-- 
    Document   : ceoInventoryCharts
    Created on : Oct 11, 2016, 1:04:21 AM
    Author     : r.chua
--%>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#"><span class="glyphicon glyphicon-user"></span> CEO </a></li>
            ...
            <div class="menu-list">
                <ul id="menu-content" class="menu-content collapse out">
                    ...
                    <ul class="sub-menu collapsed" id="products">
                        <li><a href="ceoAccntngCharts.jsp">Accounting</a></li>
                        <li class="active"><a href="ceoInventoryCharts.jsp">Inventory</a></li>
                        <li><a href="ceoSalesCharts.jsp">Sales</a></li>
                    </ul>
                        </li>
