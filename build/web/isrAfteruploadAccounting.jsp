...
<html>
    <head>
        ...
        <title>Accounting Report Summary</title>
    ...
    <body>
        ...
        <div class="container" id="main">
            <div class="row">
                <div class="col-md-12">
                    <center><h4>Accounting Report Summary</h4></center>
                 ...
                 <button type="submit" id="js-upload-submit"><a href="isrAccountingUpload.jsp">Confirm</a></button>
                </div>
            </div>
        </div>
